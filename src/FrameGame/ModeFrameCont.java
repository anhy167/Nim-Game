 ...
 * @author Acer
 */
public class ModeFrameCont extends javax.swing.JFrame {

    /**
     * Creates new form ModeFrame
     */
 
    public ModeFrameCont() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModeFrameCont.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
