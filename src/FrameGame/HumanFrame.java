 ...
 * @author Acer
 */
public class HumanFrame extends javax.swing.JFrame {
    ...
    private void takeCoinBtn1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_takeCoinBtn1MouseClicked
        ...
        if (isYourTurn == true) {
            ...
            while (true) {
                if (amount <= pile.getPileSize() / 2 && amount > 0) {
                    break;
                } else {
                    JOptionPane.showMessageDialog(this, "The number of coins taken must be less greater than "+pile.getPileSize()/2+" and greater than 0!");
                    return;
                }
            }
...
//            pile.removeMarbles(amount);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HumanFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
